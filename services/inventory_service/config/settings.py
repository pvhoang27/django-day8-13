...
SECRET_KEY = os.getenv("INVENTORY_SECRET_KEY", "dev-inventory-secret-key")
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('INVENTORY_DB_NAME', 'ecommerce_inventory'),
...
INVENTORY_INTERNAL_API_KEY = os.getenv('INVENTORY_INTERNAL_API_KEY', 'change-me')
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Inventory microservice for product and stock management.',
    'VERSION': '1.0.0',
}
